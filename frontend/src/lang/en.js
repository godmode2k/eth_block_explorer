...
*/
    ...
    tab: ["Home", "Block"],
    placeholder: "Search by Address / TXID / Block Height / Block Hash",
    filter: [
      {
        label: "All filters",
        value: 0
...
*/
  ...
  home: {
    ...
    blockTable: {
      ...
      label: ["Height", "Hash", "Transactions"]
    },
    messageTable: {
      title: "Message",
      //label: ["Message ID", "Time", "From", "To", "Value"]
      //label: ["Type", "Hash", "Height", "Time", "From", "To", "Value"]
      label: ["Hash", "Time", "From", "To", "Value"]
    },
    board: {
      height: {
        label: "Tipset Height",
  ...
  address: {
    ...
    detail: {
      ...
      overview: ["Address", "Balance", "Token"],
      worker: "Worker List",
      ownerOverview: [
        "Owner Account",
        "Peer ID",
